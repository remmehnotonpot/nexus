        ...
        <div className="bg-slate-950 text-slate-400 text-xs py-2">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <span className="hidden sm:inline">24/7 Support: +1 (800) NEXUS-GL</span>
            </div>
            <div className="flex items-center gap-4">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div className="flex flex-col">
              <span className={`font-bold text-lg leading-tight transition-colors ${
                showTransparent ? 'text-white' : 'text-slate-900 dark:text-white'
              }`}>
                NEXUS
              </span>
              <span className={`text-[10px] leading-tight tracking-wider transition-colors ${
                showTransparent ? 'text-white/80' : 'text-slate-500 dark:text-slate-400'
              }`}>
                GLOBAL LOGISTICS
              </span>
            </div>
