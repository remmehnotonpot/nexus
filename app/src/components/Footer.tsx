          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-6">
              ...
              <div className="flex flex-col">
                <span className="font-bold text-lg leading-tight text-white">NEXUS</span>
                <span className="text-[10px] leading-tight tracking-wider text-slate-500">
                  GLOBAL LOGISTICS
                </span>
              </div>
            </Link>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span>+1 (800) NEXUS-GL</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Mail className="w-4 h-4 text-orange-500" />
                <span>contact@nexuslogistics.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="flex items-center gap-3 mt-6">
              {[Linkedin, Twitter, Facebook, Instagram].map((Icon, index) => (
                <a
                  key={index}
                  href="#"
                  className="w-9 h-9 rounded-lg bg-slate-900 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all"
                >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item}>
                  <Link 
                    href="#" 
                    className="text-sm hover:text-orange-500 transition-colors inline-flex items-center gap-1 group"
                  >
                    {item}
            ...
            <div>
              ...
              <ul className="space-y-2 text-xs">
                <li>
                  ...
                  <p className="mt-1">All shipments subject to Nexus Terms and Conditions, including limitations of liability under Hague-Visby Rules or Montreal Convention.</p>
                </li>
                <li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-xs text-center md:text-left">
              Copyright © 2026 Nexus Global Logistics Holdings B.V. All rights reserved.
            </p>
          ...
          <p className="text-[10px] text-slate-600 text-center mt-4">
            ...
            Nexus and the Nexus Globe are registered trademarks of Nexus Global Solutions. 
