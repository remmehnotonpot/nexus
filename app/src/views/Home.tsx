          ...
          {features.map((feature) => (
            ...
            >
              <CardContent className="p-8 text-center">
                <div className="w-16 h-16 mx-auto mb-6 rounded-2xl bg-sky-100 dark:bg-sky-900/30 flex items-center justify-center group-hover:bg-sky-500 group-hover:text-white transition-all">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group p-6 rounded-xl bg-slate-50 dark:bg-slate-800/50 hover:bg-sky-50 dark:hover:bg-sky-900/10 transition-all cursor-pointer"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            {/* Map placeholder */}
            <Link href="/contact">
              <div className="rounded-xl overflow-hidden h-48 bg-slate-800 relative cursor-pointer group">
                <img
...
const AdBanner = () => {
  return (
    <div className="bg-gradient-to-r from-sky-500 to-sky-600 py-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
